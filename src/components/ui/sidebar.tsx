...
>(
  (
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, bottomBarVisible]
    )
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "fixed bottom-0 left-0 right-0 z-50 flex items-center bg-white dark:bg-black justify-around text-white py-3 shadow-lg",
        className,
        "md:hidden"
      )}
      {...props}
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <PanelLeft className="hidden md:block lg:block sm:hidden"/>
